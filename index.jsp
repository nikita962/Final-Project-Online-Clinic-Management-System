...
<div class="ui container first">
    <div class="ui center aligned teal inverted segment">
        <font color="black"><h1 class="header" id="nam">Online Clinic Management System</h1></font>
    </div>
  <div class="clear"> </div>
			<!--start-image-slider---->
  ...
  <div class="Box-body p-6">
        <article class="markdown-body entry-content" itemprop="text"><h1>Online Clinic Management System</h1>
<p> Dr Shweta Naik has relentlessly worked since last 25 years for preventive health.
				She practices what she preaches. She is an icon of vitality, health and positive energy.She follows a strict fitness regime which has won her many accolades and awards at various marathons, cycling and races. She is an image of youth, vigour and inspiration to all her patients</p>
</article>
</div>
  <br><br><footer>
